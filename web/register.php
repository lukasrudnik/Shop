...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['name']) && strlen(trim($_POST['name'])) >= 3 && isset($_POST['surname']) && strlen(trim($_POST['surname'])) >= 3 && isset($_POST['address']) && strlen(trim($_POST['address'])) >= 6 && isset($_POST['email']) && strlen(trim($_POST['email'])) >= 6 && isset($_POST['password']) && strlen(trim($_POST['password'])) >= 6 && isset($_POST['repeadPassword']) && trim($_POST['repeadPassword']) === trim($_POST['password'])) {
